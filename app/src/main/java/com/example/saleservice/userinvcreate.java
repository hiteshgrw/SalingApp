...
public class userinvcreate extends AppCompatActivity {
    ...
    private schoolmgmthelper getschooldet;
...
//        schoolmgmthelper.getInstance(userinvcreate.this);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(userinvcreate.this,android.R.layout.simple_spinner_item,schoolnlist);
...
//        schoolsetup();
        ...
        schlname = schoolclass.getName();
        nameschool = schoolclass.getName();
//                    Classschhelper.getInstance(userinvcreate.this,"School"+schname,"classmap");
//        Toast.makeText(this, "School"+schname, Toast.LENGTH_SHORT).show();
        classhelp = new Classschhelper(userinvcreate.this,"School"+schname,"classmap");
        classsetup();
        try {
            Start.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (Classname.getSelectedItemPosition() != 0) {
                        ...
                        //                    invoicenomap.getInstance(userinvcreate.this,"School"+schname);
                        invoicenohelp = new invoicenomap(userinvcreate.this,"School"+schname);
                        sethelp = new Classmgmthelper(userinvcreate.this, "School" + schname,"ClsdetailClass" + clsname);
                        //                    Classmgmthelper.getInstance(userinvcreate.this, "School" + schname,"ClsdetailClass" + clsname);
                        contactno = Long.parseLong(phnno.getText().toString());
                        phelp = new phnnohelper(userinvcreate.this,"PhnoSchool"+schname);
                        //                    phnnohelper.getInstance(userinvcreate.this,"PhnoSchool"+schname);
                        try {
                            ...
                            invno = 1;
                            //            Toast.makeText(userinvcreate.this, "No table", Toast.LENGTH_SHORT).show();
                        }
                        if(contactno!=0) {
    ...
    public void secondsetup()
    {
        ...
        invlstsetadapter adapter = new invlstsetadapter(userinvcreate.this,R.layout.invcrtsetdispfrmt,firstmaplist);
    ...
    {
        companyhelper = new Companymgmthelper(userinvcreate.this);
//        Companymgmthelper.getInstance(userinvcreate.this);
        for (int i = 0; i <setbll1.size() ; i++) {
            Integer cmpid = companyhelper.getid(setbll1.get(i).getCname());
            bdbhelper = new bookdatabasehelper(userinvcreate.this,"School"+schname,"Company"+cmpid+"bookdet");
//            stockhelper = new wholestockdbhelper(userinvcreate.this,"Company"+cmpid);
//            bookdatabasehelper.getInstance(userinvcreate.this,"School"+schname,"Company"+cmpid+"bookdet");
//            wholestockdbhelper.getInstance(userinvcreate.this,"Company"+cmpid);
...
//            stockhelper.updatesalestock(setbll3.get(i).getName(),presentstock+saleq);
        ...
        if (rut == true) {
            Toast.makeText(userinvcreate.this, "Invoice No  -  " + invno + " CREATED", Toast.LENGTH_SHORT).show();
        } else
            Toast.makeText(userinvcreate.this, "Invoice Failed", Toast.LENGTH_SHORT).show();
        ...
        invhelp = new invoicehelper(userinvcreate.this,"School"+schname+"INVOICENO"+invno);
//        invoicehelper.getInstance(userinvcreate.this,"School" + schname,"INVOICENO"+invno);
...
//        AlertDialog.Builder builder = new AlertDialog.Builder(userinvcreate.this);
...
//                Toast.makeText(userinvcreate.this, "THANKS TO ME", Toast.LENGTH_SHORT).show();
//                initialsetup();
//            }
//        });
...
//        dialog.show();
    ...
    public void bookmapsetup(final Integer pos)
    {
        ...
        if(setids.get(pos) == 1)
        {
            final invblladapter adap = new invblladapter(userinvcreate.this,R.layout.invbllsamplelayout,setbll1);
        ...
        {
            final invblladapter adap = new invblladapter(userinvcreate.this,R.layout.invbllsamplelayout,setbll2);
            listView1.setAdapter(adap);
            listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        {
            final invblladapter adap = new invblladapter(userinvcreate.this,R.layout.invbllsamplelayout,setbll3);
            listView1.setAdapter(adap);
            listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if(cursor.getCount()>0)
            {
                ...
                for (int i = 0; i <setids.size() ; i++) {
                    if(setids.get(i)==1)
                    {
                        ...
                        bookhelp = new booklisthelper(userinvcreate.this,"School"+schname,"BooklistClass"+clsname+"Set1");
//                        booklisthelper.getInstance(userinvcreate.this,"School"+schname,"BooklistClass"+clsname+"Set1");
...
//                            }
                    ...
                    else if(setids.get(i)==2)
                    {
                        ...
                        bookhelp = new booklisthelper(userinvcreate.this,"School"+schname,"BooklistClass"+clsname+"Set2");
//                        booklisthelper.getInstance(userinvcreate.this,"School"+schname,"BooklistClass"+clsname+"Set2");
                        Cursor cursor1 = bookhelp.display();
                        if(cursor1.getCount()>0)
                        {
                            while (cursor1.moveToNext())
...
//                            }
                    ...
                    else
                    {
                        ...
                        bookhelp = new booklisthelper(userinvcreate.this,"School"+schname,"BooklistClass"+clsname+"Set3");
//                        booklisthelper.getInstance(userinvcreate.this,"School"+schname,"BooklistClass"+clsname+"Set3");
                        Cursor cursor1 = bookhelp.display();
                        if(cursor1.getCount()>0)
                        {
                            while (cursor1.moveToNext())
...
//    }
    ...
    public void classsetup() {
        try {
            ...
            if (cursor.getCount() > 0) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(userinvcreate.this, android.R.layout.simple_spinner_item, classnlist);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void pdfgenerate() throws IOException {
        ...
        Integer uid = userhelp.getid(FirebaseAuth.getInstance().getCurrentUser().getEmail().trim(),schname);
        ...
        subtitle.setTextAlign(Paint.Align.CENTER);
        subtitle.setTextSize(8f);
        canvas.drawText(nameclass,width/2,120,subtitle);
        canvas.drawText("User : "+ FirebaseAuth.getInstance().getCurrentUser().getEmail().trim(),width/2,130,subtitle);

        subtitle.setTextAlign(Paint.Align.RIGHT);
        canvas.drawText("INVOICE NO : " + "SN"+schname+"UN"+uid+"INO"+billno, width - 20, 120, subtitle);
    ...
    public void pospdf() throws IOException {
        ...
        canvas.drawText("User : "+ FirebaseAuth.getInstance().getCurrentUser().getEmail().trim(),width/2,120,subtitle);

        subtitle.setTextAlign(Paint.Align.RIGHT);
        canvas.drawText("INVOICE NO : " + "SN"+schname+"UN"+uid+"INO"+billno, width - 20, 110, subtitle);
        dfm = new SimpleDateFormat("dd/MM/yyyy");
    ...
    private void createcontact(String savename)
    {
        ...
        {
            Toast.makeText(userinvcreate.this, "Account Type not found", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        {
            Toast.makeText(userinvcreate.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
        if(res!=null && res[0] !=null)
        {
            Uri newContacturi = res[0].uri;
            Toast.makeText(userinvcreate.this, "Contact added " + newContacturi, Toast.LENGTH_SHORT).show();
        }
        else {
            Toast.makeText(userinvcreate.this, "Failed", Toast.LENGTH_SHORT).show();
        }
    }
    private void viewpdf(String file, String directory)
    {
        ...
        if(wcheck) {
            ...
            if (rst) {
                Toast.makeText(userinvcreate.this, "Whatsapp found", Toast.LENGTH_SHORT).show();
...
//                        startActivity(intent);
                ...
                Toast.makeText(userinvcreate.this, "Whatsapp not found", Toast.LENGTH_SHORT).show();
            }
        }
        else {
            Toast.makeText(userinvcreate.this, "Invoice Generated Successfully", Toast.LENGTH_SHORT).show();
            ...
            try{
                ...
                Toast.makeText(userinvcreate.this, "pdf not found, upload failed", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
